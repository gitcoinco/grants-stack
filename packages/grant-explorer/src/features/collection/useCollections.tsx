  ...
  const renderModal = () => (
    <>
      <CollectionsModal
        ...
        open={currentModal === CurrentModal.ALLCOLLECTIONS}
        createNewCollection={() => setCurrentModal(CurrentModal.NEWCOLLECTIONS)}
        closeModal={closeModal}
      />
      <NewCollectionsModal
        project={activeProject}
        open={currentModal === CurrentModal.NEWCOLLECTIONS}
        closeModal={closeModal}
      />
    </>
  );
