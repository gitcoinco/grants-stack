  ...
  return <div>
    ...
    <div className="relative top-16 lg:mx-20 px-4 py-7 h-screen">
      <main>
        ...
        <ProjectList projects={collection.projectsMeta} roundRoutePath={`/round/${collection.chainId}/${collection.roundId}`} isBeforeRoundEndDate={collection.isBeforeRoundEndDate} />
      </main>
    </div >
  </div >
}
