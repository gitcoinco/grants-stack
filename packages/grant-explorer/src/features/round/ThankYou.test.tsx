...
describe("<TwitterButton />", () => {
  ...
  it("Should redirect to twitter with correct text", async () => {
    ...
    expect(openSpy).toHaveBeenCalledWith(
      "https://twitter.com/share?text=I%20just%20donated%20to%20Round%20and%20more%20on%20%40gitcoin%20%40grantsstack.%20Join%20me%20in%20making%20a%20difference%20by%20donating%20today%2C%20and%20check%20out%20the%20projects%20I%20supported%20on%20my%20Donation%20History%20page!%0A%0Ahttps%3A%2F%2Fexplorer.gitcoin.co%2F%23%2Fcontributors%2F0x0000000000000000000000000000000000000000",
      "_blank"
    );
  });
});
...
describe("createTwitterShareUrl", () => {
  it("encodes the url properly", function () {
    expect(
      ...
      "https://twitter.com/share?text=I%20just%20donated%20to%20a%20round%20on%20%40gitcoin%20%40grantsstack.%20Join%20me%20in%20making%20a%20difference%20by%20donating%20today%2C%20and%20check%20out%20the%20projects%20I%20supported%20on%20my%20Donation%20History%20page!%0A%0Ahttps%3A%2F%2Fexplorer.gitcoin.co%2F%23%2Fcontributors%2F0x0000000000000000000000000000000000000000"
    );
  });
});
...
describe("createTwiterShareText", () => {
  it("handles no round name", function () {
    expect(
      ...
      `I just donated to a round on @gitcoin @grantsstack. Join me in making a difference by donating today, and check out the projects I supported on my Donation History page!
...
https://explorer.gitcoin.co/#/contributors/0x0000000000000000000000000000000000000000`
  ...
  it("handles one round, no mrc", function () {
    expect(
      ...
      `I just donated to Round on @gitcoin @grantsstack. Join me in making a difference by donating today, and check out the projects I supported on my Donation History page!
...
https://explorer.gitcoin.co/#/contributors/0x0000000000000000000000000000000000000000`
  ...
  it("handles one round plus mrc", function () {
    expect(
      ...
      `I just donated to Round and more on @gitcoin @grantsstack. Join me in making a difference by donating today, and check out the projects I supported on my Donation History page!
