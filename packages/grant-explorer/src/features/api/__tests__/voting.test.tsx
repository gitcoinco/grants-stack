...
describe("encodeQFVOtes", () => {
  it("encodes votes correctly", async () => {
    ...
    const trimmedVotes = votes.map((vote) => vote.replace(/\x00/g, ''));
    const expectedVote = "";
    expect(trimmedVotes[0]).eq(expectedVote);
  });
});
