...
const roundImplementation = [
  ...
  "function initialize(bytes encodedParameters, address _roundFactory)",
  ...
  "function roundFactory() view returns (address)",
  "function roundFeeAddress() view returns (address)",
  "function roundFeePercentage() view returns (uint8)",
  ...
  "function updateRoundFeePercentage(uint8 newFeePercentage)",
