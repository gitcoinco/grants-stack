...
/// @notice Defines the abstract contract for voting algorithms on grants within a round. Any new voting algorithm would be expected to extend this abstract contract. Every IVotingStrategy contract would be unique to RoundImplementation and would be deployed before creating a round
abstract contract IVotingStrategy {
    ...
    /// @notice Invoked by RoundImplementation to allow voter to case vote for grants during a round.
    /// @dev
