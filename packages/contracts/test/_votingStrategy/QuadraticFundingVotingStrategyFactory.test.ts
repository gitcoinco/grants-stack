...
import {
  ...
  QuadraticFundingVotingStrategyFactory__factory,
...
describe("QuadraticFundingVotingStrategyFactory", function () {
  ...
  describe("constructor", () => {
    it("QuadraticFundingVotingStrategyFactory SHOULD deploy properly", async () => {
      ...
      quadraticFundingVotingStrategyContractFactory =
      ...
      // Verify deploy
      expect(
        isAddress(quadraticFundingVotingStrategyFactory.address),
        "Failed to deploy QuadraticFundingVotingStrategyFactory"
      ).to.be.true;
    });
  });
  ...
  describe("core functions", () => {
    beforeEach(async () => {
      ...
      quadraticFundingVotingStrategyImplementationArtifact =
    ...
    describe("test: updateVotingContract", async () => {
      ...
      it("QFcontract SHOULD have voting contract address after invoking updateVotingContract", async () => {
        await quadraticFundingVotingStrategyFactory
