...
import { QuadraticFundingRelayStrategyImplementation as VotingStrategyImplementation } from "../../../generated/templates";
 ...
 */
export function handleVotingContractCreated(
  event: VotingContractCreatedEvent
): void {
  ...
  if (votingStrategy) {
    log.warning(
      "--> handleVotingContractCreated {} : votingStrategy already exists",
      [votingStrategyContractAddress.toHex()]
    );
    return;
  }
