...
|----------------|----------------------------------------------|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| mainnet        | grants-round-mainnet                         | https://thegraph.com/studio/subgraph/grants-round-mainnet               | https://api.studio.thegraph.com/query/14975/grants-round-mainnet/v0.1                 |
