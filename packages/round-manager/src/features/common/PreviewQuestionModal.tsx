    ...
    return (
      <div className="flex flex-col mb-2">
        ...
        <div className="flex flex-row justify-between mt-2">
          <span className="flex text-xs text-grey-400">This info will be shown in Explorer.</span>
          <span className="text-xs text-violet-400">*Required</span>
        </div>
        <div className="flex flex-row justify-between mt-2">
          <Input className="border rounded-sm border-grey-100 p-2" disabled value="testing the value" />
        </div>
      </div>
    );
  };
