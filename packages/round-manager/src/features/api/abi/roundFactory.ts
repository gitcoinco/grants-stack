...
const roundFactory = [
  ...
  "function create(address _votingContract, uint256 _applicationsStartTime, uint256 _roundStartTime, uint256 _roundEndTime, address _token, address _ownedBy, tuple(uint256 protocol, string pointer) _metaPtr, address[] _roundOperators) returns (address)",
