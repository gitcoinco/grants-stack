...
const projectRegistryMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0xe6CCEe93c97E20644431647B306F48e278aFFdb9",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0xb0F4882184EB6e3ed120c5181651D50719329788",
};
...
const programFactoryMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0x68a14AF71BFa0FE09fC937033f6Ea5153c0e75e4",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0x6D341814Be4E2316142D9190E390b494F1dECFAf",
};
/* ProgramFactory  */
...
const roundFactoryMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0xF3B5a0d59C6292BD0e4f8Cf735EEF52b98f428E6",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0x0Bb6e2dfEaef0Db5809B3979717E99e053Cbae72",
};
/* RoundFactory  */
...
const qfVotingStrategyFactoryMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0x94cB638556d3991363102431d8cE9e839C734677",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0x8c28F21D2d8C53eedC58bF9cdCfb7DCF7d809d97",
};
...
const merklePayoutStrategyFactoryMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0x41A8F19C6CB88C9Cc98d29Cb7A4015629910fFc0",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0xbA160C13F8F626e3232078aDFD6eD2f2B2289563",
};
...
const alloSettingsContractMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0x0FD600678475C03f28baE59A2d55f7a911383e2B",
};
...
const directPayoutStrategyFactoryContractMap: ChainIdToStringMap = {
  ...
  [ChainId.ZKSYNC_ERA_MAINNET_CHAIN_ID]: "0x0ccdfCB7e5DB60AAE5667d1680B490F7830c49C8",
  [ChainId.ZKSYNC_ERA_TESTNET_CHAIN_ID]: "0x4170665B31bC10009f8a69CeaACf3265C3d66797",
};
