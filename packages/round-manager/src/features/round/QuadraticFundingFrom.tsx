        ...
        quadraticFundingConfig: yup.object({
            ...
            minDonationThresholdAmount: yup
                ...
                .when("minDonationThreshold", {
                    ...
                    then: yup
                    .number()
                    .required("You must provide an amount for the minimum donation threshold.")
...
export default function QuadraticFundingForm(
  props: QuadraticFundingFormProps
) {
      ...
      <div className="md:grid md:grid-cols-3 md:gap-10">
        ...
        <div className="mt-5 md:mt-0 md:col-span-2">
          ...
          >
            ...
            <div className="p-6 bg-white">
            <p className="text-grey-400 mb-4 mt-4">Minimum Donation Threshold</p>
            <div className="grid grid-cols-6 gap-6">
            ...
            {/* Sybil Defense */}
                <div className="p-6 bg-white">
                    ...
                    <p className="text-grey-400 mb-2 mt-1 text-sm">Ensure that project supporters are not bots or sybil with Gitcoin Passport. Learn more about Gitcoin Passport here. </p>
                    <div className="flex">
                        <SybilDefense
                            errors={errors}
                            registerMatchingCapAmount={register(
...
function LeftSidebar() {
  return (
    <div className="md:col-span-1">
      ...
      >
       What is the Round name, when do applications open/close, and when does it start and end?
       
      </p>
      <p
      className="mt-1 text-sm text-grey-400 pt-4"
      >
        You can change this settings anytime before the round starts. Learn more about QF here.
      </p>
    </div>
  );
}
...
function PayoutTokenDropdown(props: {
      ...
      <div className="col-span-6 sm:col-span-3">
        ...
        <div className="relative mt-1 rounded-md shadow-sm">
          <Input
            ...
            $hasError={
              props.errors?.roundMetadata?.quadraticFundingConfig?.matchingFundsAvailable
            }
  ...
  function MatchingCap(props: {
    ...
    const [matchingCapAmount, setMatchingCapAmount] = useState<string | undefined>(amt?.toString());
    ...
    return (
      <>
        ...
        <div className="col-span-6 sm:col-span-3">
          ...
          <div className="relative mt-1 rounded-md shadow-sm">
            ...
            <Input
                ...
                $hasError={
                    isMatchingCap &&
                    props.errors?.roundMetadata?.quadraticFundingConfig?.matchingCapAmount
                }
                type="number"
        ...
        <div className="col-span-6 rounded text-sm bg-gray-50 p-2 text-gray-500" hidden={
            !isMatchingCap
        }>
  ...
  function MinDonationThreshold(props: {
    ...
    return (
      <>
        <div className="col-span-6 sm:col-span-3">
          <RadioGroup {...minDonationThresholdField} data-testid="min-donation-selection">
            <RadioGroup.Label className="block text-sm">
              <p className="text-sm">
                <span>Do you want a minimum donation <br /> threshold for projects?</span>
                <span className="text-right text-violet-400 float-right text-xs mt-1">
                  *Required
                </span>
                <InformationCircleIcon
        ...
        <div className="col-span-6 sm:col-span-3">
          ...
          {isMinDonation &&
            props.errors?.roundMetadata?.quadraticFundingConfig?.minDonationThresholdAmount && (
              <p className="text-xs text-pink-500">
                {
                  props.errors.roundMetadata?.quadraticFundingConfig?.minDonationThresholdAmount
                    ?.message
        ...
        <div className="col-span-6 rounded text-sm bg-gray-50 p-2 text-gray-500" hidden={!isMinDonation}>
          Each donation has to be a minimum of ${minDonationAmount} USD equivalent for it to be eligible for matching.
        </div>
      </>
    );
  }
  ...
  function SybilDefense(props: {
    ...
    return (
      <>
        {" "}
        <div className="col-span-6 sm:col-span-3">
          <RadioGroup {...sybilDefenseField } data-testid="sybil-defense-selection">
            <div>
                  ...
                  <span className="flex items-center text-sm">
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400">
                        Allow matching only for donation from project supporters that have verified their identity on Gitcoin Passport.
                      </p>
                    </RadioGroup.Label>
                  </span>
                )}
