...
describe("<ApplicationsOverview />", () => {
  ...
  describe("REJECTED: when processing bulk action fails", () => {
    beforeEach(() => {
  ...
  describe("APPROVED: when processing bulk action fails", () => {
    beforeEach(() => {
      const transactionBlockNumber = 10;
      (updateRoundContract as jest.Mock).mockResolvedValue({
        transactionBlockNumber,
  ...
  describe("RECEIVED: when processing bulk action fails", () => {
    beforeEach(() => {
      const transactionBlockNumber = 10;
      (updateRoundContract as jest.Mock).mockResolvedValue({
        transactionBlockNumber,
