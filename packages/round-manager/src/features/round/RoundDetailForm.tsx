            ...
            <div className="pt-7 pb-10 sm:px-6 bg-white">
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  <label htmlFor="name" className="block text-xs font-medium">Round Name</label>
                  <Input
                    {...register("roundMetadata.name")}
                    $hasError={errors.roundMetadata?.name}
                    type="text"
                  />
                  {errors.roundMetadata?.name && <p className="text-xs text-pink-500">{errors.roundMetadata?.name?.message}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-6 gap-6 mb-1">
                <div className="col-span-6 sm:col-span-3">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Datetime
                          ...
                          inputProps={{
                            placeholder: "",
                            className: "block w-full border-0 p-0 text-gray-900 placeholder-grey-400 focus:ring-0 text-sm"
                          }}
                        />
                      )} />
                  ...
                  {errors.applicationsStartTime && <p className="text-xs text-pink-500">{errors.applicationsStartTime?.message}</p>}
                </div>

                <div className="col-span-6 sm:col-span-3">
                  <div className={`relative border rounded-md px-3 py-2 mb-2 shadow-sm focus-within:ring-1 ${errors.applicationsEndTime ? "border-red-300 text-red-900 placeholder-red-300 focus-within:outline-none focus-within:border-red-500 focus-within: ring-red-500" : "border-gray-300 focus-within:border-indigo-600 focus-within:ring-indigo-600"}`}>
                  ...
                  {errors.applicationsEndTime && <p className="text-xs text-pink-500">{errors.applicationsEndTime?.message}</p>}
                </div>
              </div>
              ...
              <div className="grid grid-cols-6 gap-6">
                <div className="col-span-6 sm:col-span-3">
                  <div className={`relative border rounded-md px-3 py-2 mb-2 shadow-sm focus-within:ring-1 ${errors.roundStartTime ? "border-red-300 text-red-900 placeholder-red-300 focus-within:outline-none focus-within:border-red-500 focus-within: ring-red-500" : "border-gray-300 focus-within:border-indigo-600 focus-within:ring-indigo-600"}`}>
                  ...
                  {errors.roundStartTime && <p className="text-xs text-pink-500">{errors.roundStartTime?.message}</p>}
                </div>

                <div className="col-span-6 sm:col-span-3">
                  <div className={`relative border rounded-md px-3 py-2 mb-2 shadow-sm focus-within:ring-1 ${errors.roundEndTime ? "border-red-300 text-red-900 placeholder-red-300 focus-within:outline-none focus-within:border-red-500 focus-within: ring-red-500" : "border-gray-300 focus-within:border-indigo-600 focus-within:ring-indigo-600"}`}>
                  ...
                  {errors.roundEndTime && <p className="text-xs text-pink-500">{errors.roundEndTime?.message}</p>}
                </div>
              </div>
            </div>
