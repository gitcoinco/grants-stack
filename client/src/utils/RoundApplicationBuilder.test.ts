...
describe("event aggregation", () => {
  it("test", () => {
    const builder = new RoundApplicationBuilder(project, roundApplicationMetadata);
    ...
    expect(application.recipient).toEqual("0x000000000000000000000000000000000000beaf");
    expect(application.answers.length).toEqual(roundApplicationMetadata.applicationSchema.length - 2);
  });
});
